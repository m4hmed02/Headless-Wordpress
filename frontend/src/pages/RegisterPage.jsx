...
import registerCustomer from "../apis/Customers/registerCustomer";
...
export default function RegisterPage({ onLoginSuccess, onSwitchToLogin }) {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      ...
      const msg = err?.response?.data?.message || err?.response?.data?.wooCommerce?.message || "Registration failed. Please try again.";
      setError(msg);
    } finally {
      setLoading(false);
    }
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    placeholder="John"
                    className="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder-gray-400"
                  />
                </div>
                <div className="flex-1">
